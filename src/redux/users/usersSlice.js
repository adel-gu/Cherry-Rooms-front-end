...
// User SignUp thunk
export const userSignUp = createAsyncThunk(USER_ACTION, async (userInfo) => {
  const data = await userAuth(SIGNUP_URL, userInfo);
  return data;
});

// User Login thunk
export const userLogin = createAsyncThunk(USER_ACTION, async (userInfo) => {
  const data = await userAuth(LOGIN_URL, userInfo);
  return data;
});

// User Logout thunk
export const userLogout = createAsyncThunk(USER_ACTION, async () => {
